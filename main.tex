\def\homeworkname{Largest Hub}
\documentclass[assignment = 7]{homework}
...
\begin{document}
    ...
    Calculate the expected maximum degree for the undirected networks listed in Table 4.1 of \href{http://networksciencebook.com/chapter/4#scale-free}{Barabasi's book `Network Science'}, except Power Grid.  Assume ($k_{\min}$) is 1 for all networks.  Explain your reasoning.
